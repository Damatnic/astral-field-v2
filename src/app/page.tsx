    ...
    <div className="min-h-screen bg-gray-50">
                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
                  <div>
                    ...
                    <h1 className="text-4xl tracking-tight font-bold text-gray-900 sm:text-5xl md:text-6xl">
                      ...
                      <span className="block text-green-600">League</span>
                    </h1>
      ...
      <div className="bg-green-600">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <button
            onClick={() => router.push('/login')}
            className="mt-8 w-full inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-green-600 bg-white hover:bg-gray-50 sm:w-auto"
          >
            Sign In Now
            <ChevronRight className="ml-2 w-5 h-5" />
          </button>
