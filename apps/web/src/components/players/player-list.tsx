...
export function PlayerList({ players, currentPage, totalPages, totalCount }: PlayerListProps) {
  ...
  const getPlayerTrend = (stats: Player['stats']) => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4">
        {players.map((player: any) => {
          const trend = getPlayerTrend(player.stats)
          const avgPoints = player.stats.length > 0 
          ...
          return (
            <div key={player.id} className="bg-slate-800/50 rounded-lg border border-slate-700 p-6 hover:border-slate-600 transition-colors">
