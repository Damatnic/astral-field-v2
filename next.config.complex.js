...
const nextConfig = {
  // Experimental features (simplified for Vercel deployment)
  experimental: {
    typedRoutes: true,
  ...
  // Build configuration
  eslint: {
    ignoreDuringBuilds: true, // Skip during build for faster deployment
  },
  typescript: {
    ignoreBuildErrors: true, // Skip during build for faster deployment
  },
  ...
  // Output configuration (standalone mode disabled for Vercel deployment)
  ...
  async headers() {
    ...
    // Development vs Production CSP - Fixed for production deployment with Google Fonts support
    const cspHeader = process.env.NODE_ENV === 'production'
      ? "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://vercel.live https://*.vercel-analytics.com https://*.sentry.io; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://r2cdn.perplexity.ai; img-src 'self' blob: data: https:; font-src 'self' data: https://fonts.gstatic.com https://fonts.googleapis.com https://r2cdn.perplexity.ai; connect-src 'self' https://*.sentry.io https://*.vercel-analytics.com wss://*.vercel.live https://api.sportsdata.io https://fonts.googleapis.com https://fonts.gstatic.com https://r2cdn.perplexity.ai; frame-ancestors 'none';"
      : "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://r2cdn.perplexity.ai; img-src 'self' blob: data: https:; font-src 'self' data: https://fonts.gstatic.com https://fonts.googleapis.com https://r2cdn.perplexity.ai; connect-src 'self' ws: wss: https://fonts.googleapis.com https://fonts.gstatic.com https://r2cdn.perplexity.ai; frame-ancestors 'none';";
